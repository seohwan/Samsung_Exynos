...
if [ $gpu == mp12 ]; then
    echo 0 > /sys/devices/platform/19700000.G3D1/util_enable    
elif [ $gpu == mp3_00 ]; then
    echo 0 > /sys/devices/platform/19300000.G3D00/util_enable
elif [ $gpu == mp3_01 ]; then
    echo 0 > /sys/devices/platform/19500000.G3D01/util_enable
else
